...
public class PlayerMovementManager : MonoBehaviour
{
    ...
    protected void MovePlayerOverNetwork()
    {
        ...
        {
            transform.position = xMove + Vector3.MoveTowards(new Vector2(0, transform.position.y), new Vector2(0, lastPositionOnNetwork.y), Time.deltaTime * -TERMINAL_SPEED * 1.4f);
        }
        else
        {
